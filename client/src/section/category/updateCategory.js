...
import { getLoadingSelector,getCategorySelector,updateLoadingSelector } from '../../features/category/selectors/categorySelectors'
import { useParams } from 'react-router-dom';

export default function UpdateCategory({showModel,setShowModel,categoryId}) {
