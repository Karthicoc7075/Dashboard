...
import { createLoadingSelector } from '../../features/user/selectors/userSelectors'



export default function CreateUser({showModel,setShowModel}) {
            ...
            <Close />
                    ...
                    <FormControl  fullWidth   >
                            ...
                            <Box sx={{
                               ...
                               {loading ? <CircularProgress /> : <Button variant='contained' sx={{ p: 1.2,backgroundImage:(theme)=> theme.palette.gradientColors[4], mt: 2 }} onClick={()=>submitHandler()} >Create User</Button>}
                            </Box>
            </Card>
    </Box>
</Modal>
