...
export const    UPDATE_MATERAL_STATUS_REQUEST = 'UPDATE_MATERAL_STATUS_REQUEST';
export const    UPDATE_MATERAL_STATUS_SUCCESS = 'UPDATE_MATERAL_STATUS_SUCCESS';
export const    UPDATE_MATERAL_STATUS_FAILURE = 'UPDATE_MATERAL_STATUS_FAILURE';
