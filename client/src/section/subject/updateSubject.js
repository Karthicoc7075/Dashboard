...
import { getLoadingSelector,updateLoadingSelector,getSubjectSelector } from '../../features//subject/selectors/subjectSelectors'
import { useParams } from 'react-router-dom';

export default function UpdateSubject({showModel,setShowModel,subjectId}) {
